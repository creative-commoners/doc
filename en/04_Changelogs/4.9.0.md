...
- sboyd Changed parameter type in [SilverStripe\Logging\HTTPOutputHandler::write()](api:SilverStripe\Logging\HTTPOutputHandler::write) for `$record` from `array` to `Monolog\LogRecord`
